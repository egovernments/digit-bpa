...
public class RearYardService extends GeneralRule {
    ...
    private Boolean residentialUptoTenMts(Block block, Integer level, final BigDecimal min, final BigDecimal mean,
            final OccupancyTypeHelper mostRestrictiveOccupancy, RearYardResult rearYardResult, String subRule, String rule,
        ...
        /*
         * if (-1 == level) { subRule = SUB_RULE_24_12; rule = BSMT_REAR_YARD_DESC; subRuleDesc = SUB_RULE_24_12_DESCRIPTION; }
         */
    ...
    private Boolean allOccupancyForHighRise(Block block, Integer level, final BigDecimal min, final BigDecimal mean,
        ...
        /*
         * if (-1 == level) { rule = BSMT_REAR_YARD_DESC; subRuleDesc = SUB_RULE_24_12_DESCRIPTION; subRule = SUB_RULE_24_12; }
         */
