...
public class PermitRenewalLetterToPartyController extends BpaGenericApplicationController {
    ...
    private void prepareData(final PermitRenewalLetterToParty lettertoParty, final PermitRenewal permitRenewal,
            final Model model) {
    ...
    public String createLetterToParty(
            ...
            @Valid @ModelAttribute("permitRenewalLetterToParty") final PermitRenewalLetterToParty permitRenewalLTP,
    ...
    public String updateLettertoparty(@PathVariable final String applicationNumber,
            @Valid @ModelAttribute("LETTERTO_PARTY") final PermitRenewalLetterToParty lettertoparty,
            final Model model,
    ...
    public String capturesentdate(@PathVariable final Long id, final Model model) {
        ...
        model.addAttribute(LETTERTO_PARTY, lettertoParty);
        model.addAttribute(LETTERTOPARTYDOC_LIST, lettertoParty.getLetterToParty().getLetterToPartyDocuments());
        model.addAttribute(PERMIT_RENEWAL, lettertoParty.getPermitRenewal());
    ...
    public String createLettertoPartyReply(@PathVariable final Long id, final Model model) {
        PermitRenewalLetterToParty lettertoParty = lettertoPartyService.findById(id);
        return lpReplyFormData(model, lettertoParty);
    }

    private String lpReplyFormData(final Model model, PermitRenewalLetterToParty lettertoParty) {
        model.addAttribute(LETTERTO_PARTY, lettertoParty);
        model.addAttribute(LETTERTOPARTYDOC_LIST, lettertoParty.getLetterToParty().getLetterToPartyDocuments());
        model.addAttribute(PERMIT_RENEWAL, lettertoParty.getPermitRenewal());
    ...
    public String createLettertoPartyReply(
            @Valid @ModelAttribute("LETTERTO_PARTY") final PermitRenewalLetterToParty lettertoparty, final BindingResult errors,
            final Model model,
