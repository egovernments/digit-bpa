...
public class BpaNocApplicationController {
    ...
    public String getNocApplication(@PathVariable final String applicationNumber, final Model model,
        ...
        return nocEditForm(model, permitNoc);
    }

    private String nocEditForm(final Model model, PermitNocApplication permitNoc) {
    ...
    public String updateNoc(@PathVariable final String applicationNumber,
            @Valid @ModelAttribute final PermitNocApplication permitNocApplication,
            final BindingResult result,
            final HttpServletRequest request,
            final Model model, final RedirectAttributes redirectAttributes) {

        if (result.hasErrors()) {
            return nocEditForm(model, permitNocApplication);
        }
