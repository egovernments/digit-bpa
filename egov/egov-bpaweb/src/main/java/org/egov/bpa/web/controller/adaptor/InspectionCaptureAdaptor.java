...
public class InspectionCaptureAdaptor implements DataTableJsonAdapter<SearchBpaApplicationForm> {
    ...
    public JsonElement serialize(final DataTable<SearchBpaApplicationForm> baseRegisterResponse, final Type type,
        ...
        baseRegisterResult.forEach(baseForm -> {
            ...
            baseRegisterJson.addProperty("wfEnded", baseForm.getWfEnded());
            baseRegisterJson.addProperty("occupancyCertificateNumber", baseForm.getOccupancyCertificateNumber() == null ? "N_A" : String.valueOf(baseForm.getOccupancyCertificateNumber()));
