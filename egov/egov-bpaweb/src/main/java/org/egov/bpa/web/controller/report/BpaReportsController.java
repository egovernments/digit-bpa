...
public class BpaReportsController extends BpaGenericApplicationController {
    ...
    @GetMapping(value = "/servicewise-statusreport")
    ...
    @PostMapping(value = "/servicewise-statusreport", produces = MediaType.TEXT_PLAIN_VALUE)
    @ResponseBody
    ...
    @GetMapping("/servicewise-statusreport/view")
    ...
    @PostMapping(value = "/servicewise-statusreport/view", produces = MediaType.TEXT_PLAIN_VALUE)
    @ResponseBody
    ...
    @PostMapping(value = "/zonewisedetails", produces = MediaType.TEXT_PLAIN_VALUE)
    @ResponseBody
    ...
    @GetMapping("/slotdetails/{applicationType}")
    ...
    @PostMapping(value = "/slotdetails/{applicationType}", produces = MediaType.TEXT_PLAIN_VALUE)
    @ResponseBody
    public String getSlotDetailsResult(@PathVariable String applicationType,
            @Valid @ModelAttribute final SlotDetailsHelper slotDetailsHelper, final BindingResult result,
            final Model model) {
    ...
    @GetMapping("/slotdetails/viewapplications")
    ...
    @PostMapping(value = "/slotdetails/viewapplications", produces = MediaType.TEXT_PLAIN_VALUE)
    @ResponseBody
    ...
    @PostMapping(value = "/failureinscheduler", produces = MediaType.TEXT_PLAIN_VALUE)
    @ResponseBody
    public String showApplicationFailureInSchedulerRecords(
            @Valid @ModelAttribute final SearchBpaApplicationForm searchBpaApplicationForm, final BindingResult result,
            final Model model) {
    ...
    @PostMapping(value = "/personalregister", produces = MediaType.TEXT_PLAIN_VALUE)
    @ResponseBody
    ...
    @GetMapping("/bparegister")
    public String searchBpaRegisterForm(final Model model) {
        prepareUserBndryAndFormData(model);
        return "bpa-register-report";
    }

    @PostMapping(value = "/bparegister", produces = MediaType.TEXT_PLAIN_VALUE)
    @ResponseBody
    ...
    @PostMapping(value = "/nocclearance", produces = MediaType.TEXT_PLAIN_VALUE)
    @ResponseBody
