...
$(document)
		.ready(
				function() {
					...
					var viewurl = '/bpa/application/permitrenewal/view/';
					var collectfeeurl = '/bpa/application/permit/renewal/generate-bill/';
					var renewalorderurl = '/bpa/application/renewal/generaterenewalorder/';
					var rejectionnoticeurl = '/bpa/application/permitrenewal/rejectionnotice/';
								...
								.dataTable(
										{
                                            ...
                                            "order": [[1, 'asc']],
											ajax : {
												url : "/bpa/application/permitrenewal/search",
												type : "POST",
												beforeSend : function() {
													$('.loader-class')
															.modal(
														...
														"render" : function(
															...
															if (row.status == 'Approved' && row.isFeeCollected && row.feeCollector) {
																return ('<select class="dropchange" style="width:160px;font-size: small">'+commonOptions+'<option  value='
																		+ collectfeeurl
																		+ row.applicationNumber + '>Pay Renewal Permit Fee</option></select>');
