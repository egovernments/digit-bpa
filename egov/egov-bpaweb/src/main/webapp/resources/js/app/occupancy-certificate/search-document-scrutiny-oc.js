...
$(document)
    .ready(
        function() {
            ...
            var documentScrutinyUrl = '/bpa/application/occupancy-certificate/document-scrutiny/';
            var rescheduleUrl = '/bpa/application/occupancy-certificate/scrutiny/reschedule/';
                    ...
                    .dataTable(
                        {
                            ...
                            "order": [[1, 'asc']],
                            ajax : {
                                url : "/bpa/application/occupancy-certificate/search/document-scrutiny",
                                type : "POST",
                                beforeSend : function() {
                                    $('.loader-class')
                                        .modal(
                            ...
                            columns : [
                                ...
                                },
                                {
                                    ...
                                    "render" : function(
                                        data, type,
                                        row, meta) {
                                        if(!row.isFeeCollected && !row.rescheduledByEmployee){
