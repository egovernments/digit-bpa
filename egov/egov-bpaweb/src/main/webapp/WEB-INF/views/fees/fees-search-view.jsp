...
<div class="row" id="page-content">
    <div class="col-md-12">
        <form:form role="bpafeeform" method="post" modelAttribute="bpaFeeMapping" class="form-horizontal form-groups-bordered">
...
<script>
    ...
    var feeId = '${bpaFeeMapping.bpaFeeCommon.id}';
</script>
<script src="<cdn:url value='/resources/js/app/fee-search.js?rnd=${app_release_no}'/>"></script>
