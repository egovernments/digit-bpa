...
<form:form role="form" action="/bpa/inspection/lettertoparty/update/${inspectionApplication.applicationNumber}" method="post"
	modelAttribute="inspectionLetterToParty" id="lettertoPartyform"
...
<div class="panel-heading custom_form_panel_heading">
						...
						<div class="form-group">
							...
							<div class="col-sm-3 add-margin view-content text-justify">
								<c:out
									value="${inspectionLetterToParty.inspectionApplication.applicationNumber}"
									default="N/A"></c:out>
							</div>
							<div class="col-sm-3 control-label text-right">
							...
							<fmt:formatDate
								value="${inspectionLetterToParty.inspectionApplication.applicationDate}"
						...
						<div class="form-group">
							...
							<div class="col-sm-3 add-margin view-content text-justify">
								<c:out
									value="${inspectionLetterToParty.inspectionApplication.status.code}"
									default="N/A"></c:out>
							</div>
							...
							<div class="col-sm-3 add-margin view-content text-justify">
								<c:out
									value="${inspectionLetterToParty.inspectionApplication.buildingConstructionStage.name}"
									default="N/A"></c:out>
							</div>
</div>					<div class="panel-heading custom_form_panel_heading">
						<div class="panel-title">
					...
					<div class="panel-body">
						<div class="row add-border">
							...
							<div class="col-sm-3 add-margin view-content">
								<c:out value="${inspectionLetterToParty.letterToParty.lpNumber}"></c:out>
							</div>
							<div class="col-sm-3 add-margin">
								<spring:message code="lbl.lp.date" />
							</div>
							<div class="col-sm-3 add-margin view-content">
								<fmt:formatDate value="${inspectionLetterToParty.letterToParty.letterDate}" pattern="dd/MM/yyyy" var="letterDate" />
								<c:out value="${letterDate}"></c:out>
							</div>
							
							<form:hidden path="inspectionApplication.id" id="applicationId"
								value="${inspectionApplication.id}" />

							<form:hidden path="letterToParty.letterDate" id="letterDate"
								value="${letterDate}" />
								<form:hidden path="id" value="${inspectionLetterToParty.id}" />
							<input type="hidden" id='inspectionLetterToParty' name="inspectionLetterToParty"
						...
						<div class="row add-border">
							...
							<div class="col-sm-3 add-margin view-content">
								<c:forEach items="${inspectionLetterToParty.letterToParty.lpReason}" var="lpReason"
									varStatus="status">
							...
							<div class="col-sm-3 add-margin">
								...
								<div class="col-sm-3 add-margin view-content">
									<c:out value="${inspectionLetterToParty.letterToParty.lpDesc}" />
								</div>
						</div>
						<div class="row add-border">
							<div class="col-sm-3 add-margin">
							...
							<div class="col-sm-3 add-margin view-content">
								<fmt:formatDate value="${inspectionLetterToParty.letterToParty.lastReplyDate}" pattern="dd/MM/yyyy" var="lastReplyDate" />
...
<script
	src="<cdn:url value='/resources/js/app/ins-lettertoparty-helper.js?rnd=${app_release_no}'/> "></script>
