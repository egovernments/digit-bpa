            ...
            <div class="panel-body">
                <div class="row add-border">
                    ...
                    <div class="col-sm-3 add-margin view-content">
                        <c:out value="${inspectionLetterToParty.letterToParty.lpNumber}" default="N/A"></c:out>
                    </div>
                ...
                <div class="row add-border">
                    ...
                    <div class="col-sm-9 add-margin view-content text-justify">
                        <c:out value="${inspectionLetterToParty.letterToParty.lpDesc}" default="N/A"></c:out>
                    </div>
                </div>

                <div class="row add-border">
                    <c:if test="${inspectionLetterToParty.letterToParty.replyDate !=null }">
                        <div class="col-sm-3 add-margin">
                            <spring:message code="lbl.lpreplydate"/>
                        </div>
                        <div class="col-sm-3 add-margin view-content">
                            <fmt:formatDate value="${inspectionLetterToParty.letterToParty.replyDate}" pattern="dd/MM/yyyy" var="replyDate"/>
                            <c:out value="${replyDate}" default="N/A"></c:out>
                        </div>
                    </c:if>
                </div>
                <div class="row add-border">
                    <c:if test="${inspectionLetterToParty.letterToParty.lpReplyRemarks !=null }">
                        <div class="col-sm-3 add-margin">
                            <spring:message code="lbl.lpReplyRemarks"/>
                        </div>
                        <div class="col-sm-9 add-margin view-content text-justify">
                            <c:out value="${inspectionLetterToParty.letterToParty.lpReplyRemarks}" default="N/A"></c:out>
                        </div>
                    </c:if>
                </div>
            </div>
                ...
                <table class="table table-bordered  multiheadertbl">
                    ...
                    <tbody>
                        <c:choose>
                            ...
                            <c:otherwise>
                                <div class="col-md-12 col-xs-6  panel-title"><spring:message code='lbl.no.documents.found'/></div>
                            </c:otherwise>
                        </c:choose>
                    </tbody>
                </table>
