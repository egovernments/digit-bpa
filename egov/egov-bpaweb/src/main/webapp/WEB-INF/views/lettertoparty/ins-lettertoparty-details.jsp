					...
					<tr id="lprow">
						...
						<td align="center" class="view-content" style="font-size: 90%;">
							<c:choose>
								...
								<c:otherwise>
									<a style="cursor: pointer; font-size: 12px;" href="/bpa/inspection/lettertoparty/capturesentdate/${inspn.id}">
						...
						<td align="center" class="view-content" style="font-size: 90%;">
							<c:choose>
								...
								<c:otherwise>
									<a style="cursor: pointer; font-size: 12px;"  href="/bpa/inspection/lettertoparty/update/${bpaApplication.applicationNumber}">
						...
						<td align="center" class="view-content" style="font-size: 90%;">
							<c:choose>
								...
								<c:otherwise>
									<a style="cursor: pointer; font-size: 12px;" href="/bpa/inspection/lettertoparty/lettertopartyreply/${inspn.id}">
						...
						<td align="center" class="view-content" style="font-size: 90%;"><a style="cursor: pointer; font-size: 14px;"
								onclick="window.open('/bpa/inspection/lettertoparty/viewdetails/lpreply/${inspn.id}','view','width=600, height=400,scrollbars=yes')">
...
<script
		src="<cdn:url value='/resources/js/app/lettertoparty/ins-lettertoparty-helper.js?rnd=${app_release_no}'/> "></script>
