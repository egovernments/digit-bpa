            ...
            <div class="panel-body">
                <div class="row add-border">
                    ...
                    <div class="col-sm-3 add-margin view-content">
                        <c:out value="${permitRenewalLetterToParty.letterToParty.lpNumber}" default="N/A"></c:out>
                    </div>
                ...
                <div class="row add-border">
                    ...
                    <div class="col-sm-9 add-margin view-content text-justify">
                        <c:out value="${permitRenewalLetterToParty.letterToParty.lpDesc}" default="N/A"></c:out>
                    </div>
                </div>

                <div class="row add-border">
                    <c:if test="${permitRenewalLetterToParty.letterToParty.replyDate !=null }">
                        <div class="col-sm-3 add-margin">
                            <spring:message code="lbl.lpreplydate"/>
                        </div>
                        <div class="col-sm-3 add-margin view-content">
                            <fmt:formatDate value="${permitRenewalLetterToParty.letterToParty.replyDate}" pattern="dd/MM/yyyy" var="replyDate"/>
                            <c:out value="${replyDate}" default="N/A"></c:out>
                        </div>
                    </c:if>
                </div>
                <div class="row add-border">
                    <c:if test="${permitRenewalLetterToParty.letterToParty.lpReplyRemarks !=null }">
                        <div class="col-sm-3 add-margin">
                            <spring:message code="lbl.lpReplyRemarks"/>
                        </div>
                        <div class="col-sm-9 add-margin view-content text-justify">
                            <c:out value="${permitRenewalLetterToParty.letterToParty.lpReplyRemarks}" default="N/A"></c:out>
                        </div>
                    </c:if>
                </div>
            </div>
