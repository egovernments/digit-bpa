...
<form:form role="form" action="/bpa/inspection/lettertoparty/lettertopartyreply"
	method="post" modelAttribute="inspectionLetterToParty" id="lettertoPartyReplyform"
...
<div class="panel-heading custom_form_panel_heading">
				...
				<div class="panel-body">
					...
					<div class="row add-border">
						...
						<div class="col-sm-3 add-margin  view-content">
							<fmt:formatDate value="${inspectionLetterToParty.letterToParty.sentDate}" pattern="dd/MM/yyyy" var="sentDate" />
