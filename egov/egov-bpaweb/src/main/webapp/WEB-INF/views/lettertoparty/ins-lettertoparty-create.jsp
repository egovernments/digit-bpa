...
<form:form role="form" action="/bpa/inspection/lettertoparty/create/${inspectionApplication.applicationNumber}" method="post"
			...
			<div class="panel panel-primary" data-collapsed="0">
				<%-- <jsp:include page="../application/viewapplication-details.jsp"></jsp:include> --%>
						...
						<div class="form-group">
							...
							<div class="col-sm-3 add-margin view-content text-justify">
								<c:out
									value="${inspectionLetterToParty.inspectionApplication.remarks}"
									default="N/A"></c:out>
							</div>
						</div>
				<div class="panel-heading custom_form_panel_heading">
				...
				<div class="panel-body">
					...
					<form:hidden path="inspectionApplication.id" id="inspectionApplicationId"
