...
<form:form role="form" action=""
	modelAttribute="searchBpaApplicationForm" id="searchOwnershipForm"
...
<script src="<cdn:url value='/resources/js/app/ownershipTransfer/searchownershiptransfer.js?rnd=${app_release_no}'/> "></script>
