...
<div class="row">
	...
	<div class="panel-heading">
		...
		<form:form role="form" action="/bpa/citizen/application/ownership/transfer/update/${ownershipTransfer.applicationNumber}" method="post" modelAttribute="ownershipTransfer"
			...
			<div class="tab-content">
				...
				<div id="document-info" class="tab-pane fade">
					<div class="panel panel-primary" data-collapsed="0">
						<jsp:include page="permit-ownership-documents.jsp"></jsp:include>
					</div>
				</div>
