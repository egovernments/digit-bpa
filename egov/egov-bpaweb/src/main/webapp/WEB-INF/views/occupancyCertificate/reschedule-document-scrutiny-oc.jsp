    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-primary" data-collapsed="0">
                <jsp:include page="view-scheduled-scrutiny-details-oc.jsp"></jsp:include>
            </div>
            <c:forEach items="${occupancyCertificate.ocSlots}" var="ocslot"
                ...
                <c:if test="${counter.last}">
                    <input type="hidden" id="previousAppointmentDate"
                           value="${ocslot.slotDetail.slot.appointmentDate}" />
                    <input type="hidden" id="previousAppointmentTime"
                           value="${ocslot.slotDetail.appointmentTime}" />
                </c:if>
            </c:forEach>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group" id="scheduleElements">
                        ...
                        <div class="col-sm-3 add-margin">
                            ...
                            <input type="hidden" name="applicationNumber" id="applicationNumber" value="${occupancyCertificate.applicationNumber}">
                            <input type="hidden" name="applicationId" id="applicationId" value="${occupancyCertificate.id}">
                            <input type="hidden" name="zoneId" id="zoneId" value="${occupancyCertificate.parent.siteDetail[0].adminBoundary.parent.id}">
            ...
            <br>
            <div class="panel panel-primary" data-collapsed="0">
                <jsp:include page="../application/reschedule-scrutiny-notes.jsp"></jsp:include>
            </div>
        </div>
    </div>
</form:form>
