...
<div class="panel-body">
    <table class="table table-bordered  multiheadertbl">
        <thead>
        <tr>
            <th width="4%"><spring:message code="lbl.srl.no"/></th>
            <th width="13%"><spring:message code="lbl.documentname"/></th>
        ...
        <tbody>
        <c:choose>
            <c:when test="${not empty  occupancyCertificate.getDcrDocuments()}">
                <c:forEach items="${occupancyCertificate.getDcrDocuments()}" var="dcrDoc"
                           varStatus="dcrStatus">
                    <tr>
                        ...
                        <td class="view-content" style="font-size: 97%;"><c:set value="false" var="isDocFound"></c:set>
                            <c:forEach
                                    var="dcrFile" items="${dcrDoc.dcrDocument.getOrderedDcrAttachments()}" varStatus="dcrLoop">
