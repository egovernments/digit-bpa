...
<div class="panel-heading custom_form_panel_heading">
    <div class="panel-title">
     	<c:choose>
			<c:when
				test="${not empty ocInspection.inspection.planScrutinyChecklistForDrawingTemp}">
				<c:out
					value="${ocInspection.inspection.planScrutinyChecklistForDrawingTemp[0].serviceChecklist.checklist.checklistType.description} " />
			</c:when>
			<c:otherwise>
				<c:out
        ...
        <c:choose>
            <c:when
                ...
                <c:forEach var="planScrutinyDraw"
                           items="${ocInspection.inspection.planScrutinyChecklistForDrawingTemp}"
