...
<div class="row">
	<div class="col-md-12">
		<form:form role="form" action="../create" method="post"
			modelAttribute="permitRevocation" id="permitRevocationInitiateForm"
				...
				<div class="panel-body">
					<div class="form-group">
						<label class="col-sm-3 control-label text-right"><spring:message
								code="lbl.revoke.initiate.reason" /><span class="mandatory"></span></label>
						<div class="col-sm-6 add-margin">
						<form:hidden path="application" value="${permitRevocation.application.id}"/>
							<form:textarea path="initiateRemarks" id="address"
								class="form-control patternvalidation"
								data-pattern="alphanumericspecialcharacters" required="required"
								maxlength="1012" cols="5" rows="4" />
							<form:errors path="initiateRemarks"
			...
			<div class="text-center">
				<button type='submit' class='btn btn-primary'
					id="initiateRevokeSubmit">
					<spring:message code='lbl.init.revoke.btn' />
				</button>
