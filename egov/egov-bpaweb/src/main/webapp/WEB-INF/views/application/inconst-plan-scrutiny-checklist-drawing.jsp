...
<div class="panel-heading custom_form_panel_heading">
    <div class="panel-title">
     	<c:choose>
			<c:when
				test="${not empty inConstructionInspection.inspection.planScrutinyChecklistForDrawingTemp}">
				<c:out
					value="${inConstructionInspection.inspection.planScrutinyChecklistForDrawingTemp[0].serviceChecklist.checklist.checklistType.description} " />
			</c:when>
			<c:otherwise>
				<c:out
        ...
        <c:choose>
            <c:when
                ...
                <c:forEach var="planScrutinyDraw"
                           items="${inConstructionInspection.inspection.planScrutinyChecklistForDrawingTemp}"
                    ...
                    <tr>
                        <td> <form:hidden
                                ...
                                value="${planScrutinyDraw.serviceChecklist.id}"/><form:hidden
