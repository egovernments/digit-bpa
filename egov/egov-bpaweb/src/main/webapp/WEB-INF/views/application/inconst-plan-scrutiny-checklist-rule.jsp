...
<div class="panel-body">
    <table class="table table-bordered  multiheadertbl"
        ...
        <c:choose>
            <c:when
                    test="${not empty inConstructionInspection.inspection.planScrutinyChecklistForRuleTemp}">
                <c:forEach var="planScrutiny"
                           items="${inConstructionInspection.inspection.planScrutinyChecklistForRuleTemp}"
