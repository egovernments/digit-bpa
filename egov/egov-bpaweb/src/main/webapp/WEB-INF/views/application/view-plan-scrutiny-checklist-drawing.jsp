...
<div class="panel-heading custom_form_panel_heading">
    <div class="panel-title">
		<c:out value="${permitInspection.inspection.planScrutinyChecklistForDrawing[0].serviceChecklist.checklist.checklistType.description}" />
    </div>
</div>
<div class="panel-body">
    <table class="table table-bordered  multiheadertbl"
        ...
        <c:forEach var="planScrutiny"
                   items="${permitInspection.inspection.planScrutinyChecklistForDrawing}"
