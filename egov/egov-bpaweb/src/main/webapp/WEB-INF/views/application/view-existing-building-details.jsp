...
<div class="panel-body display-hide">
    <c:if test="${not empty bpaApplication.existingBuildingDetails}">
        <c:forEach
            ...
            <c:if
                    test="${not empty existBldg.existingBuildingFloorDetails}">
                ...
                <div <c:if
                    ...
                    <table class="table table-striped table-bordered"
                        ...
                        <tr>
                            ...
                            <th class="text-center"><spring:message code="lbl.sub.occupancy"/></th>
                        ...
                        <c:forEach
                                items="${existBldg.existingBuildingFloorDetails}"
                            ...
                            <input type="hidden" value="${floorDetails.id}"
                                   ...
                                   name="bpaApplication.existingBuildingDetails[0].existingBuildingFloorDetails[${counter.index}].id"/>
                            <tr class="data-fetched">
                                ...
                                <td class="text-center view-content"><c:out
                                        value="${floorDetails.subOccupancy.name}" default="0"></c:out>
