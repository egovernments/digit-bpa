...
<form:form role="form" modelAttribute="ocNoc" id="editOCNocApplicationForm"
 action="/bpa/ocnocapplication/updateNoc/${ocNoc.bpaNocApplication.nocType}~${ocNoc.oc.applicationNumber}"
 method="post" 
			cssClass="form-horizontal form-groups-bordered"
			enctype="multipart/form-data">
			<input type="hidden" name="permitNoc" value="${ocNoc.id}">
			<input type="hidden" name="id" value="${ocNoc.id}">
<div class="row">
	<div class="col-md-12">		
			...
			<div id="application-info" class="tab-pane fade in active">
		    	       ...
		    	       <div class="panel-heading custom_form_panel_heading">				
						...
						<div class="form-group">
							...
							<div class="col-sm-3 add-margin view-content text-justify">
								<c:out value="${ocNoc.bpaNocApplication.nocApplicationNumber}"
									default="N/A"></c:out>
							</div>
							<div class="col-sm-3 control-label text-right">
								<spring:message code="lbl.noc.app.date" />
							</div>
							<fmt:formatDate value="${ocNoc.bpaNocApplication.createdDate}"
						...
						<div class="form-group">
							...
							<div class="col-sm-3 add-margin view-content text-justify">
								<c:out value="${ocNoc.bpaNocApplication.status.code}"
									default="N/A"></c:out>
							</div>							
						</div>	
					</div>
    	           ...
    	           <div class="panel-heading custom_form_panel_heading">				
	                	<div class="panel-title">Comments</div>
		                      ...
		                      <c:out value="${ocNoc.bpaNocApplication.remarks}"
									default="N/A"></c:out>		
			</div>			
    	    </div>  	    
