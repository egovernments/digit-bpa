...
<div class="panel-body display-hide ">
	...
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content text-justify">
			<c:out value="${noc.bpaApplication.siteDetail[0].reSurveyNumber}"
				default="N/A"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
		...
		<div class="col-sm-3 add-margin view-content text-justify">
			<c:out value="${noc.bpaApplication.siteDetail[0].natureofOwnership}"
				default="N/A"></c:out>
		</div>
	</div>
	...
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content text-justify">
			<c:out value="${noc.bpaApplication.siteDetail[0].khataNumber}"
				default="N/A"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
		...
		<div class="col-sm-3 add-margin view-content text-justify">
			<c:out value="${noc.bpaApplication.siteDetail[0].holdingNumber}"
				default="N/A"></c:out>
		</div>
	</div>
	...
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content text-justify">
			<c:out value="${noc.bpaApplication.siteDetail[0].nearestbuildingnumber}"
				default="N/A"></c:out>
		</div>
		<div class="doorNo">
			<div class="col-sm-3 add-margin">
			...
			<div class="col-sm-3 add-margin view-content text-justify">
				<c:out value="${noc.bpaApplication.siteDetail[0].plotdoornumber}"
					default="N/A"></c:out>
			</div>
		</div>
	</div>
	...
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content text-justify">
			<c:out value="${noc.bpaApplication.siteDetail[0].streetaddress1}"
				default="N/A"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
		...
		<div class="col-sm-3 add-margin view-content text-justify">
			<c:out value="${noc.bpaApplication.siteDetail[0].streetaddress2}"
				default="N/A"></c:out>
		</div>
	</div>
	...
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content text-justify">
			<c:out value="${noc.bpaApplication.siteDetail[0].citytown}" default="N/A"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
			<spring:message code="lbl.plot.no" />
		</div>
		<div class="col-sm-3 add-margin view-content text-justify">
			<c:out value="${noc.bpaApplication.siteDetail[0].mspPlotNumber}"
				default="N/A"></c:out>
		</div>
