...
<div class="panel-body">
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content">
			<input type="hidden" id="ocEDcrNumber"
				value="${oc.eDcrNumber}">
			<c:out value="${oc.eDcrNumber}" default="N/A"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
	...
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content">
			<c:out value="${oc.applicationNumber}"
				default="N/A"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
		...
		<div class="col-sm-3 add-margin view-content">
			<fmt:formatDate value="${oc.applicationDate}"
	...
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content">
			<fmt:formatDate value="${oc.commencedDate}"
		...
		<div class="col-sm-3 add-margin view-content">
			<fmt:formatDate value="${oc.completionDate}"
