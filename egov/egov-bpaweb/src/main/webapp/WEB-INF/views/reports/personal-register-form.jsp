        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <div class="col-sm-3 add-margin">
                    <form:select path="serviceTypeEnum" data-first-option="true"
                    ...
                    <form:errors path="serviceTypeEnum" cssClass="add-margin error-msg" />
                </div>
            </div>
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-3 add-margin">
                        <form:select path="userId" data-first-option="false" id="userId"
                        ...
                        <form:errors path="userId" cssClass="add-margin error-msg"/>
                    </div>
