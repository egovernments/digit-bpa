...
<form:form role="form" action=""
	modelAttribute="checklistServiceTypeMapping" cssClass="form-horizontal form-groups-bordered"
			...
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title">
						<spring:message code="lbl.checklist.servicetype.search.title" />
					</div>
				</div>
				<div class="panel-body">
					<div class="form-group">
						<label class="col-sm-3 control-label"><spring:message
								code="lbl.checklist.type" /></label>
						<div class="col-sm-3 add-margin">
							<select	name="checklistType" id="checklist" class="form-control">
						...
						<spring:message	code="lbl.servicetype" /></label>
						<div class="col-sm-3 add-margin">
...
<div class="row display-hide report-section" id="table_container">
	...
	<div class="col-md-12 form-group report-table-container">
		<table class="table table-bordered table-hover multiheadertbl"
			id="search_checklist_servicetype_mapping_table">
			<thead>
				<tr>
					<th><spring:message code="lbl.checklist" /></th>
					<th><spring:message code="lbl.servicetype" /></th>
...
<script
	src="<cdn:url value='/resources/js/app/checklist-servicetype-mapping.js?rnd=${app_release_no}'/> "></script>
