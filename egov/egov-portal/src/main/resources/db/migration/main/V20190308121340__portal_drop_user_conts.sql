...
ALTER TABLE egp_portallink DROP CONSTRAINT fk_c_portallink_createdby;
ALTER TABLE egp_portallink DROP CONSTRAINT fk_c_portallink_lastmodifiedby;
ALTER TABLE egp_portallink DROP CONSTRAINT fk_c_portallink_user;