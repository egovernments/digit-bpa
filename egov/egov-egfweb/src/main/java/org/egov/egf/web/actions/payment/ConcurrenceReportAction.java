    ...
    private Map<String, Map<String, Object>> getQueryString() {
        ...
        if (StringUtils.isNotBlank(chequeOrRTGS)) {
            ...
            queryString
                    ...
                    .append("vh1.id =iv.VOUCHERHEADERID,egw_status egws, state.eg_user egusr where ph.voucherheaderid=vh.id and gl.debitamount!=0 and gl.debitamount is not null")
            ...
            queryString
                    ...
                    .append("vh1.id =iv.VOUCHERHEADERID,egw_status egws, state.eg_user egusr where ph.voucherheaderid=vh.id and gl.debitamount!=0 and gl.debitamount is not null and vh.id= vmis.voucherheaderid and ")
                    .append("vmis.departmentid= d.id_dept and ph.state_id=es.id and egusr.id_user=ph.createdby and es.value='END' and gl.voucherheaderid=vh.id and ")
                    .append(" ms.payvhid=vh.id and ph.voucherheaderid=vh.id and ")
                    .append(dateQry)
                    .append(bankQry)
                    ...
                    .append("paymentheader ph,eg_wf_states es, state.eg_user egusr,egw_status egws,(select ih1.id,ih1.id_status from egf_instrumentheader ih1, ")
