...
public class PlanInformation implements Serializable {
	...
	/*
	 * public Boolean getNocToAbutSide() { return nocToAbutSide; }
	 * 
	 * public void setNocToAbutSide(Boolean nocToAbutSide) { this.nocToAbutSide =
	 * nocToAbutSide; }
	 */
	/*
	 * public Boolean getNocToAbutRear() { return nocToAbutRear; }
	 * 
	 * public void setNocToAbutRear(Boolean nocToAbutRear) { this.nocToAbutRear =
	 * nocToAbutRear; }
	 */
