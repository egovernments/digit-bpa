...
public class Building extends Measurement {
    ...
    public String toString() {
        ...
        str.append("Building :").append(newLine).append("buildingHeight:").append(buildingHeight).append(newLine)
                .append("totalFloorArea:").append(totalFloorArea).append(newLine).append("far:").append(far)
                .append(newLine).append("Coverage:").append(coverage).append(newLine).append("totalFloors:")
                .append(totalFloors).append(newLine).append("floorsAboveGround:").append(floorsAboveGround)
                .append(newLine).append("maxFloor:").append(maxFloor).append(newLine).append("area:")
                .append(area).append(newLine).append("Floors Count:").append(floors.size()).append(newLine)
                .append("Exterior wall:").append(exteriorWall).append(newLine).append("Floors:")
                .append(floors).append(newLine);
        return str.toString();
    }
