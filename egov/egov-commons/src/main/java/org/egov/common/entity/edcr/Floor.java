		...
		if (occupancies == null) {
			...
			occupancies.get(occupancies.indexOf(occupancy))
					.setBuiltUpArea((occupancies.get(occupancies.indexOf(occupancy)).getBuiltUpArea() == null
							? BigDecimal.ZERO : occupancies.get(occupancies.indexOf(occupancy)).getBuiltUpArea())
		...
		if (occupancies == null) {
			...
			occupancies.get(occupancies.indexOf(occupancy))
					.setDeduction((occupancies.get(occupancies.indexOf(occupancy)).getDeduction() == null
							? BigDecimal.ZERO : occupancies.get(occupancies.indexOf(occupancy)).getDeduction())
