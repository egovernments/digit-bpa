...
$(document)
		.ready(
				function() {
					var updateurl = '/common/checklist/update/';
					var viewurl = '/common/checklist/view/';
					...
					function callAjaxUpdateSearch() {
						...
						$("#search_checklist_list_table")
								.dataTable(
										{
											ajax : {
												url : "/common/checklist/search/update/",
												type : "POST",
												beforeSend : function() {
													$('.loader-class')
															.modal(
											...
											columns : [
													...
													},
													{
														...
														"render" : function(
															...
															/*&nbsp <button type="button" class="btn btn-xs btn-secondary edit" value='
															+ deleteurl
															+ row.id
															+ '><span class="glyphicon glyphicon-edit"></span>&nbsp;Mark As Working Day</button>';
															 */
														}
													} ]
										});
