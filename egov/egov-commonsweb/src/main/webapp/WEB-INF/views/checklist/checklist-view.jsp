...
<form:form role="form" action="" modelAttribute="searchChecklist" id="checklist"
	cssClass="form-horizontal form-groups-bordered"
	enctype="multipart/form-data">
	<jsp:include page="checklist-searchform.jsp"></jsp:include>
...
<div class="row display-hide report-section" id="table_container">
	...
	<div class="col-md-12 form-group report-table-container">
		<table class="table table-bordered table-hover multiheadertbl"
			id="search_checklist_list_table">
			<thead>
				<tr>
					<th><spring:message code="lbl.checklist.type" /></th>
...
<script
	src="<cdn:url value='/resources/app/js/searchchecklist.js?rnd=${app_release_no}'/> "></script>
