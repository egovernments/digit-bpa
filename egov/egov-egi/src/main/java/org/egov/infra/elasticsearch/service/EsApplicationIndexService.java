...
import org.egov.infra.elasticsearch.repository.EsApplicationIndexRepository;
import org.egov.infra.elasticsearch.service.es.EsApplicationDocumentService;
...
public class EsApplicationIndexService {

    private final EsApplicationIndexRepository applicationIndexRepository;
    private final EsApplicationDocumentService applicationDocumentService;

    @Autowired
    private CityService cityService;

    @Autowired
    public EsApplicationIndexService(EsApplicationIndexRepository applicationIndexRepository,
            EsApplicationDocumentService applicationDocumentService) {
