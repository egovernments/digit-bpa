  ...
  <div class="item-list training-ttutorial">
    ...
    <ul class="tutorial-list">
      ...
      <li class="tutorial-item">
       ...
       <li class="tutorial-item">
        <a href="<cdn:url value='/resources/guide/assets/layermatrix/multiple-occupancies-Dated 01-05-2019.dwg'/>" target="_blank">Layer Matrix for multiple occupancies</a>
      </li>
        <li class="tutorial-item">
