...
VALUES (nextval('SEQ_EG_APPCONFIG_VALUES'), (SELECT id FROM EG_APPCONFIG WHERE KEY_NAME='OC_FEE_CALCULATION' and module= (select id from eg_module where name='BPA')), current_date, 'AUTOFEECAL',0);
