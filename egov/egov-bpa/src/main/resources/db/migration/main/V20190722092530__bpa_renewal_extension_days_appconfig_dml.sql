...
VALUES (nextval('SEQ_EG_APPCONFIG_VALUES'),(SELECT id FROM EG_APPCONFIG WHERE KEYNAME='PERMIT_RENEWAL_APPLY_PRIOR_DAYS_BEFORE_EXPIRY'
...
INSERT INTO eg_appconfig_values ( ID, CONFIG, EFFECTIVEFROM, VALUE, VERSION ) 
VALUES (nextval('SEQ_EG_APPCONFIG_VALUES'),(SELECT id FROM EG_APPCONFIG WHERE KEYNAME='PERMIT_RENEWAL_ALLOWED_UPTO_AFTER_EXPIRY'
