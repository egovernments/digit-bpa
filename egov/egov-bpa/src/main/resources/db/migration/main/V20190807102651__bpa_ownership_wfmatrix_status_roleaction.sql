...
Insert into eg_appconfig (ID,KEYNAME,DESCRIPTION,MODULE) values 
...
Insert into eg_appconfig_values (ID,CONFIG,EFFECTIVEFROM,VALUE) values 
(nextval('seq_eg_appconfig_values'),(select id from eg_appconfig where KEYNAME ='AUTOGENERATE_OWNERSHIP_NUMBER'),current_date,'NO');
