...
VALUES (nextval('SEQ_EG_APPCONFIG_VALUES'), (SELECT id FROM EG_APPCONFIG WHERE KEY_NAME='STATE_LOGO' and module= (select id from eg_module where name='BPA')), current_date, '/egi/resources/global/images/logo@2x.png',0);
