...
update eg_boundary set parent = (select id from eg_boundary where name = 'Zone-3' ) where id in (select id from eg_boundary where name = 'Gandhi Road');
 ...
 update eg_boundary set parent = (select id from eg_boundary where boundarytype  in ( select id from eg_boundarytype where hierarchytype  =(select id from eg_hierarchy_type where upper(name)='ADMINISTRATION') and name='City'))  where boundarytype  in ( select id from eg_boundarytype where hierarchytype  =(select id from eg_hierarchy_type where upper(name)='ADMINISTRATION') and name='Ward');  
 update eg_boundary set parent = (select id from eg_boundary where boundarytype  in ( select id from eg_boundarytype where hierarchytype =(select id from eg_hierarchy_type where upper(name)='LOCATION') and name='City'))   where boundarytype  in ( select id from eg_boundarytype where hierarchytype  =(select id from eg_hierarchy_type where upper(name)='LOCATION') and name='Locality');  
 update eg_boundary set parent =null  where boundarytype  in ( select id from eg_boundarytype where hierarchytype =(select id from eg_hierarchy_type where upper(name)='LOCATION') and name='City');
 update eg_boundary set parent =null where boundarytype  in ( select id from eg_boundarytype where hierarchytype =(select id from eg_hierarchy_type where upper(name)='ADMINISTRATION') and name='City');
