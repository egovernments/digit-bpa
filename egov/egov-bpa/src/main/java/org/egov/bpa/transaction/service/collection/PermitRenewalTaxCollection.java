...
public class PermitRenewalTaxCollection extends TaxCollection {
    ...
    @Autowired
    private BpaWorkflowRedirectUtility redirectUtility;
    ...
    @Autowired
    private PermitRenewalBillService renewalBillService;
    ...
    public void updateDemandDetailForReceiptCreate(final Set<ReceiptAccountInfo> accountDetails, final EgDemand demand,
        ...
        for (final EgDemandDetails dmdDtls : demandDetailList) {
            ...
            demandDetailByReason = new ConcurrentHashMap<>(0);
    ...
    public List<ReceiptDetail> reconstructReceiptDetail(final String billReferenceNumber,
        ...
        final EgBill bill = renewalBillService.updateBillWithLatest(billID);
