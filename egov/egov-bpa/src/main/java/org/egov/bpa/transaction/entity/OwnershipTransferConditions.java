...
@Entity
@Table(name = "egbpa_ownershiptransfer_conditions")
@SequenceGenerator(name = OwnershipTransferConditions.SEQ_OWNERSHIP_CONDITIONS, sequenceName = OwnershipTransferConditions.SEQ_OWNERSHIP_CONDITIONS, allocationSize = 1)
public class OwnershipTransferConditions extends AbstractAuditable {

    private static final long serialVersionUID = 771762227114807254L;

    public static final String SEQ_OWNERSHIP_CONDITIONS = "seq_egbpa_ownershiptransfer_conditions";
