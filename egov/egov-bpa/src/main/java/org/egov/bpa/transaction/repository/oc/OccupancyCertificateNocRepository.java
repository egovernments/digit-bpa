...
@Repository
public interface OccupancyCertificateNocRepository extends JpaRepository<OccupancyNocApplication, Long> {
	
	@Query("select noc from OccupancyNocApplication noc where noc.oc.applicationNumber =:appNo")
	List<OccupancyNocApplication> findByOCApplicationNumber(@Param("appNo") String appNo);
	...
	OccupancyNocApplication findByApplicationNumberAndType(@Param("appNo") String appNo, @Param("type") String nocType);	
