...
/**
 * The Interface InspectionWorkflow.
 */
@FunctionalInterface
public interface InspectionWorkflowCustom {
	...
	public void createCommonWorkflowTransition(PermitInspectionApplication permitInspection, WorkflowBean wfBean);
