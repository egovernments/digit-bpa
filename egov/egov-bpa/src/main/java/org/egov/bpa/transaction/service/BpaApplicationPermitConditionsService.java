...
public class BpaApplicationPermitConditionsService {
    ...
    @Transactional
    public void delete(List<ApplicationPermitConditions> applicationPermitConditions) {
        bpaApplicationPermitConditionsRepository.deleteInBatch(applicationPermitConditions);
    }
