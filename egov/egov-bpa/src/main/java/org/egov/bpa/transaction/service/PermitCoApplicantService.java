...
public class PermitCoApplicantService {
    ...
    public PermitCoApplicant findById(Long id) {
        return permitCoApplicantRepository.findOne(id);
    }

    @Transactional
    public void delete(final List<PermitCoApplicant> coApplicants) {
    	permitCoApplicantRepository.deleteInBatch(coApplicants);
    }
}
