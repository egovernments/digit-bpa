...
public class BPASmsAndEmailService {
	...
	private static final String BODY_KEY_EMAIL_BPA_APPLN_NEW_PWD = "msg.bpa.newappln.email.body.pawd";
	...
	private void buildSmsAndEmailForBPANewAppln(final BpaApplication bpaApplication, final String applicantName,
        ...
        if (bpaUtils.isCitizenAcceptanceRequired()) {
            ...
            if ((BpaConstants.APPLICATION_STATUS_SUBMITTED).equalsIgnoreCase(bpaApplication.getStatus().getCode())
                    && bpaApplication.isCitizenAccepted()) {
