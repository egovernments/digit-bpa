...
@Entity
@Table(name = "EGBPA_PERMIT_INSPECTIONAPPLICATION")
@SequenceGenerator(name = PermitInspectionApplication.SEQ_INSPECTION, sequenceName = PermitInspectionApplication.SEQ_INSPECTION, allocationSize = 1)
public class PermitInspectionApplication extends AbstractAuditable {
