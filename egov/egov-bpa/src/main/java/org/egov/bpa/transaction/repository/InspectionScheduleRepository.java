...
public interface InspectionScheduleRepository extends JpaRepository<InspectionSchedule, Long> {
    ...
    List<InspectionSchedule> findByInspectionApplicationOrderByIdDesc(InspectionApplication inspectionAPplication);

    
    List<InspectionSchedule> findByIdOrderByIdAsc(Long id);
