...
@Entity
@Table(name = "egbpa_permitrenewal_letter_to_party")
@SequenceGenerator(name = PermitRenewalLetterToParty.SEQ_LETTERTOPARTY, sequenceName = PermitRenewalLetterToParty.SEQ_LETTERTOPARTY, allocationSize = 1)
public class PermitRenewalLetterToParty extends AbstractAuditable {

    private static final long serialVersionUID = 3078684328383202788L;
    public static final String SEQ_LETTERTOPARTY = "seq_egbpa_permitrenewal_letter_to_party";
