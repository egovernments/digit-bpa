...
<script
	src="<cdn:url value='/resources/global/js/bootstrap/bootbox.min.js' context='/egi'/>"></script>
<script
	src="<cdn:url value='/resources/global/js/egov/custom.js?rnd=${app_release_no}' context='/egi'/>"></script>
<script
	src="<cdn:url value='/resources/js/app/positionsearch.js?rnd=${app_release_no}' context='/eis'/>"></script>
</head>
<body class="page-body">
					...
					<form:form id="" method="post"
						...
						<div class="form-group">
							<div class="text-center">
								<button type="button" id="positionSearch"
										...
										<div class="row">
											...
											<div class="col-md-3 col-xs-6 add-margin view-content">
												<input type="text" class="form-control" maxlength="4"
													size="4" id='outSourcedPost' disabled>
											</div>
											<div class="col-md-3 col-xs-6 add-margin">
											...
											<div class="col-md-3 col-xs-6 add-margin view-content">
												<input type="text" class="form-control" maxlength="4"
													size="4" id='sanctionedPost' disabled>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-6 col-xs-6 table-header">List of
								Positions</div>
	...
	<div class="modal fade position-modal" id="position-modal"
		...
		<div class="modal-dialog">
			<div class="modal-content">
					...
					<form id="position-form"
							...
							<div class="col-md-8">
								...
								<div class="form-group">
									<input type="text" class="form-control"
										id='departmentname-edit' readonly="readonly">
							...
							<div class="col-md-8">
								...
								<div class="form-group">
									<input type="text" class="form-control" placeholder=""
										id='designationname-edit' readonly="readonly">
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-8">
								...
								<div class="form-group">
									<input type="text"
										class="form-control is_valid_letters_space_hyphen_underscore"
										placeholder="" id='positionname-edit' required="required">
						...
						<div class="row">
							...
							<div class="col-md-8">
								...
								<div class="col-sm-6 col-xs-6 add-margin">
									<input type="radio" id="outSourced-Yes" name="posts"
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-primary add-fav">Save
						Position</button>
