...
public class ViewAndUpdateEmployeController {
    ...
    private void setDropDownValues(final Model model) {
        ...
        model.addAttribute("boundaryType", boundaryTypeService
                .getBoundaryTypeByHierarchyTypeName(eisUtils.getAppconfigValueByKeyName(EMPLOYEE_JURISDICTION_HIERARCHY)));
    }
