		...
		<div class="container-fluid">
			<div class="navbar-header col-lg-4 col-md-6 col-sm-2 col-xs-3">
				<a class="navbar-brand" href="javascript:void(0);"> <img
					...
					height="60">
					<div>
						<span class="title2 hidden-sm hidden-xs citizen-title">Citizen
							Portal<br>${cityName}</span>
					</div>
				</a>
			</div>
			<div class="nav-menu col-lg-4 col-xs-12">
				<ul class="hr-menu text-center">
					<li class="active"><a class="menu-item " href="/portal/home"
						data-show-screen="#inbox-template"> <span class="title">Inbox</span><span
							id="unreadMessageCount" class="badge custom-badge"> </span></a></li>
					<span class="separator">|</span>
					<li><a class="menu-item" href="javascript:void(0);"
						data-show-screen="#myaccount">My Account</a></li>
					<span class="separator">|</span>
					<li><a class="menu-item" href="javascript:void(0);"
						data-show-screen="#newreq">New Request</a></li>
				</ul>
			</div>
			<!--/.nav-collapse -->
			...
			<div class="col-lg-4 col-md-6 col-sm-5 col-xs-9 nav-right-menu home">
				<ul class="hr-menu text-right">
					...
					<li class="ico-menu"><a href="javascript:void(0);"
						title="Help"> <i class="fa fa-question-circle"></i>
					</a></li>

					<li class="ico-menu"><a class="dropdown-toggle"
						href="javascript:void(0);" data-toggle="dropdown"> <i
							class="fa fa-user"></i>${userName}
					</a>
						<ul class="right-arrow dropdown-menu" role="menu">
							<li><a href="/egi/home/profile/edit" data-open-popup><i
									class="fa fa-user"></i>Edit Profile</a></li>
							<li><a href="javascript:void(0);"
								onclick="jQuery('.change-password').modal('show', {backdrop: 'static'});"><i
									class="fa fa-key"></i>Change Password</a></li>
							<li><a href="/egi/logout"><i class="fa fa-sign-out"></i>Sign
									out</a></li>
						</ul></li>
