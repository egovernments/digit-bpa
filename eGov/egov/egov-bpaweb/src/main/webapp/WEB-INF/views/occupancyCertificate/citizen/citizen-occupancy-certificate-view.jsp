...
<div class="row">
	<div class="col-md-12">
		<form:form role="form" action="" method="post"
				   modelAttribute="occupancyCertificate" id="citizenOccupancyCertificateViewForm"
				   cssClass="form-horizontal form-groups-bordered"
				   enctype="multipart/form-data">

			<form:hidden path="" id="workFlowAction" name="workFlowAction"/>
			<form:hidden path="" id="wfstateDesc" value="${occupancyCertificate.state.value}" />
			...
			<input type="hidden" id="applicationStatus" value="${occupancyCertificate.status.code}">
			...
			<div class="tab-content">
				...
				<c:if test="${not empty occupancyCertificate.inspections}">
					<div id="view-inspection" class="tab-pane fade">
						...
						<div class="panel panel-primary" data-collapsed="0">
							<jsp:include page="../inspection/oc-view-town-surveyor-remarks.jsp"></jsp:include>
						</div>
					</div>
				</c:if>
				<c:if test="${not empty letterToPartyList && mode eq 'showLPDetails'}">
		...
		<div class="buttonbottom" align="center">
			<table>
				<tr>
					...
					<c:if test="${occupancyCertificate.status.code eq 'Order Issued to Applicant' }">
						<td>
