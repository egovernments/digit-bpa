...
public class PostalAddressService {
    ...
    public List<PostalAddress> getPostalAddressList(final String pincode) {
        final Criteria criteria = getCurrentSession().createCriteria(PostalAddress.class, "postalAddress");
